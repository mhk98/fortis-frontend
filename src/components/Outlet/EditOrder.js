...
//           // Prevent reducing if bill is printed
...
//     if (!items.length) return alert("No items for edit.");
//     try {
//       const res = await updateTblSales(data).unwrap(); // unwrap gives direct access to the response or throws on error
//       console.log("Order updated:", res.success);
...
//           <div>
//             <div className="font-semibold text-lg mb-2">Order Item</div>
...
//                   <th className="border px-2 py-1">Price (Total)</th>
